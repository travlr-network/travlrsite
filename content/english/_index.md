...
features:
  - title: "What Makes Travlr.network Unique"
    ...
    bulletpoints:
      ...
      - "P2P networking for efficient, direct data sharing between participants"
      - "Decentralized Identity (DID) for full user control over personal information"
      - "Smart contract-powered travel insurance for automated claims processing"
      - "Interoperable loyalty programs across multiple travel services"
    button:
      enable: true
  ...
  - title: "Transforming the Travel Industry"
    ...
    bulletpoints:
      ...
      - "Decentralized booking systems for direct, peer-to-peer transactions"
      - "Seamless data sharing across different travel services"
      - "Enhanced privacy and security for sensitive travel information"
  ...
  - title: "Join the Future of Travel"
    ...
    bulletpoints:
      ...
      - "For Service Providers: Direct access to customers and reduced operational costs"
      - "For Developers: A robust platform to build innovative travel applications"
      - "For the Industry: A more efficient, secure, and user-centric travel ecosystem"
    button:
      enable: true
      label: "Get Involved"
      link: "/community"
